...
import com.wokivovich.tacocloud.entity.IngredientRef;
...
public class JdbcOrderRepository implements OrderRepository{
    ...
    private void saveIngredientRefs(Long tacoId, List<Ingredient> ingredients) {
        ...
        ingredients.forEach(ingredient -> ingredientRefs.add(new IngredientRef(ingredient.getId())));
